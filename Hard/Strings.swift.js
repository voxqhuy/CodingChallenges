...
func KaprekarsConstant(_ num: Int) -> Int { 
    let bigNum = Int(String(Array(String(format: "%04d", num)).sorted(by: >)))!
    let smallNum = Int(String(Array("\(num)").sorted(by: <)))!
    let difference = bigNum - smallNum
    return difference == 6174 ? 1 : (1 + KaprekarsConstant(difference))
}

print(KaprekarsConstant(2111))		\\ return "5"
print(KaprekarsConstant(9831))      \\ return "7"